...
dsi_connect_detect(struct drm_connector *connector,
		bool force)
{
  ...
  if(con_list->connector_type == DRM_MODE_CONNECTOR_HDMIA &&
     con_list->status == connector_status_connected){
		printk("change dsi to disconnect \n");
